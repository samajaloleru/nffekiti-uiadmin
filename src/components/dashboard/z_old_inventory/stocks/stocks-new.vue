        ...
        <div class="pa2 bg-washed-yellow br2 cf">
            ...
            <div class="w-100">
                ...
                <div class="fl pa2 mt3 mt0-ns w-100 w-third-l">
                    <label class="db fw4 lh-copy f6 black">Stock Title</label>
                    <input class="pa2 ba b--silver br2 bg-white w-100" type="text" v-model="record.Title">
                </div>
            </div>

            <stocklines :refid="0" ref="stocklines" />
            ...
            <div class="fl w-100 mt3">
                <div v-if="isSave" class="fr ph3 pv2 br1 bg-near-black near-white grow-ns pointer f6 tc no-underline" @click="save" >Submit</div>
            </div>
        </div>
    </section>
</template>
...
<script type="text/javascript">
    ...
    import stocklines from "@/components/dashboard/inventory/stocks/stocks-new-lines"
    ...
    export default {
        ...
        data() {
            return {
            url: "/api/stocks",
            record: { Code: "stock", Currency:"ZAR", Workflow:"draft", Docdate: new Date().toISOString().slice(0,10), Totalincltax:0, Taxamount:0, Totalexcltax:0, Discountamount:0},
            notifications: [],
            partnerList: [],
            ownerList: [],
            isSave: true,
            ...
            save() {
                ...
                .then(response => {
                    ...
                    if(response.data.Body !== null && response.data.Code == 200){
                        ...
                        app.$refs.stocklines.saveLines(parseInt(response.data.Body));
                    }
                }).catch(e => {
                    console.log(e);
                });
