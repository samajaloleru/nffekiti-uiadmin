<template>
    <section>
        ...
        <div class="pv2 mt4 dib w-100" id="tableReport">
            ...
            <div class="cf w-100 near-black tracked tc b f3" colspan="5">MATCH REPORT</div>
                ...
                <table-display>
                    ...
                    <template slot="tableBody" v-if="recordList.length > 0">
                        <tr class="stripe-dark" v-for="(birthday, index) in recordList" :key="index">
                            <td class=" pa2 tr pr2">
                            <router-link data-glyph="eye" class="oi br-pill bg-green hover-bg-dark-green ph1 pt1 near-white" :to="{name:'match-view',params:{id:birthday.ID}}" >
                            </router-link>
                            </td>
                            <td class=" pa2">
