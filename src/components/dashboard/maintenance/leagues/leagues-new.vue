    ...
    <section>
        ...
        <div class="w-100 pa2 bg-green fixed z-999 cf inline-flex-ns items-center-ns relative">
            <div class="fl w-100 pa1 tc tl-ns pb fw5 tracked ttu f7 white ">
                Maintenance / League Management / New
            </div>
                ...
                <form action="sign-up_submit" method="get" accept-charset="utf-8"  >
                    ...
                    <div class="fl w-100">
                        <div class="fl ph1 mt3 w-100 w-50-ns">
                            <label class="db fw4 lh-copy f6 black">Leaguename </label>
                            <input class="pa2 ba b--silver br2 bg-white w-100 " type="text" v-model="record.Leaguename">
                        </div>
