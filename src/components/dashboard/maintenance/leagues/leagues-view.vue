	...
	<section>
        ...
        <div class="w-100 pa2 bg-green fixed z-999 cf inline-flex-ns items-center-ns relative">
            <div class="fl w-100 pa1 tc tl-ns pb fw5 tracked ttu f7 white ">
                Maintenance / League Management / View
            </div>

            <div class="white pa2 br1 tc tr-ns f7 fl w-100 db dib-ns absolute-ns left-0-ns w-80-l">
                <router-link :to="{'name':'leagues-search'}" class="ph2 br1 bg-near-white pointer f6 near-black tc no-underline">
        ...
        <div class="pa2 fl w-100">
            ...
            <div v-if="isFound" class="pa2 bg-washed-yellow br1 cf">
                ...
                <img :src="record.Image" @error="record.Image = leagueIcon" class="w4 br-100 bg-near-white pa1"/>
                </div>
                ...
                <div class="fl w-100">
                    <div class="fl ph1 mt3 w-100 w-50-ns">
                        <label class="db fw4 lh-copy f6 black" for="Leaguename">Leaguename </label>
                        <input class="pa2 ba b--silver br2 bg-white w-100 " disabled="disabled" type="text" v-model="record.Leaguename">
                    </div>
                ...
                <div class="fl w-100 mt3">
                    <router-link :to="{name:'leagues-edit',params:{id:record.ID}}" class="fr ph3 pv2 br1 bg-near-black near-white grow-ns pointer f6 tc no-underline" >
