<template>
	<section class="pa2 pa3-l">
	  ...
	  <table-display>
		<template slot="tableHead">
		  <tr class="tl bg-black black f7">
			...
			<td class="">
			  <input type="text" v-model="search.filter.partner" placeholder="Customer" class="ba b--black-10 f7 fl tracked bg-white black pa1 w-100 br1">
			</td>
			<td class="">
	  ...
	  <div v-if="recordList.length < 1">
		<h1 class="black f6 tc ma5">There are currently no invoices record </h1>
	  </div>
