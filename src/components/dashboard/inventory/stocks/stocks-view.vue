<template>
    <section class="pa2 pa3-l">
        ...
        <div v-if="isFound" class="bg-light-gray br4 cf pa2">
            ...
            <div class="fr pa2 dib">
                <span class="bg-near-black br2 ph2 pv1 pointer" @click="printLetterHead('letterHeadPrint')">
                    <span class="oi white" data-glyph="print"></span>
                </span>
            </div>
			...
			<stocklines id="tableReport" :refid="$route.params.id" />
