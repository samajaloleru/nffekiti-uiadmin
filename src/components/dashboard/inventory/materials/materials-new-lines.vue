    ...
    <section class="ph2">
        <table-display class="fl w-100" style="max-height:30vh">
            <template slot="tableHead" class="fixed">
                ...
                <td class="pa2 w5">Name of Fabric</td>
                <td class="pa2 w4">Color</td>
                <td class="pa2 w4">Meters</td>
                <td class="pa2 w3">Quantity</td>
                <td class="pa2 w3">Cost Per Meter</td>
            ...
            <template slot="tableBody">
                ...
                <td class="ph1 w4 f7">
                    <input class="pa1 ba b--silver br2 bg-white w-100" type="text" v-model="line.Color" >
                </td>
                <td class="ph1 w4 f7">
                    <input class="pa1 ba b--silver br2 bg-white w-100" type="text" v-model="line.Uom" >
                </td>
                <td class="ph1 w3 f7">
		...
		saveLines(ID){
            ...
            HTTP.post(app.url, recordLines, { withCredentials: true }).then(response => {
                ...
                if (response.data.Code == 200) {
                    app.$router.push({ name: "materials-view", params: { id: ID } });
                }
            }).catch(e => { console.log(e); });
        },
        updateParentTotal() {
