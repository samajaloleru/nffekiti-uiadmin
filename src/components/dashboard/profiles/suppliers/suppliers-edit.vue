    ...
    <section class="pa2 pa3-l">
      ...
      <div v-if="isFound" class="">
        ...
        <div class="bg-light-gray ph2 pb2 br4 br--bottom cf black">
            ...
            <div class="ph2"  :class="{'':tabProps.supplierShow,'dn':!tabProps.supplierShow}">
...
<script type="text/javascript">
  ...
  import documentlines from "@/components/dashboard/profiles/suppliers/suppliers-edit-document"
