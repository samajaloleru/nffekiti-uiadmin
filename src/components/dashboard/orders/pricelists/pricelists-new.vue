<template>
		<section class="pa2 pa3-l">
			...
			<div class="pa2 bg-light-gray br4 cf">
                ...
                <pricelistlines :refid="0" ref="pricelistlines" />
...
<script type="text/javascript">
    ...
    import pricelistlines from "@/components/dashboard/orders/pricelists/pricelists-new-lines"
			...
			save () {
				...
				.then((response) => {
                    ...
                    if(response.data.Body !== null && response.data.Code == 200){
                        ...
                        app.$refs.pricelistlines.saveLines(parseInt(response.data.Body));
                    }
				}).catch((e) => {
					console.log(e)
				})
